...
const data = [
	{
		image1_url: '/news/Kolumbiya.jpg',
		image2_url: '/news/Kolumbiya2.jpg',
		createdAt: '16.02.2024',
		description:
			'<h1>Universitetlararo hamkorlik</h1><p>Xalqaro ijtimoiy innovatsiyalar universiteti (XIIU) rektori Azizov Ulugbek AQShning Kolumbiya universiteti «Pedagogika» fakultetiga tashrif buyurdi. Maqsad – ikki oliy ta’lim muassasalari o’rtasida akademik aloqalarni o’rnatish, talaba va professor- o’qituvchilar almashinuvini yo’lga qo’yish.</p>',
