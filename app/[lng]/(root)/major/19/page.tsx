...
const data = [
	{
		...
		url: '19',
		description:
			'<h2>Kafedra: Iqtisodiyot fanlari</h2><p><strong>O`qish davri:</strong> 4 yil</p><p><strong>Talab etiladigan kreditlar soni:</strong> 240</p><p><strong>Ishga joylashish imkoniyatlari:</strong> Axborot xavfsizligi sohasida dasturchi; davlat va nodavlat idoralar, banklar, moliyaviy tashkilotlarning IT bo`linmalarida dasturchi-mutaxassis; xususiy bisnezda IT-tadbirkor; soha bo`yicha xorijda va O`zbekistonda ishlash imkoniyatlari.</p><p><strong>Ta`lim shakli va to`lov kontrakt qiymati:</strong> kunduzgi – 17 000 000 so`m (1 yil uchun)</p><p><strong>Ta`lim shakli va to`lov kontrakt qiymati:</strong> kechki – 17 000 000 so`m (1 yil uchun)</p><p><strong>Ta`lim shakli va to`lov kontrakt qiymati:</strong> sirtqi – 12 000 000 so`m (1 yil uchun)</p><p><strong>Kirish imtihonlari:</strong> matematika va mantiq fanidan test</p><p><strong>Ta`lim yo`nalishi tavsifi:</strong></p><p>Axborot texnologiyalar davrida kompyuterlar insonlar hayotida tobora muhim o`rin tuta boshlamoqda. Ushbu dastur doirasida talabalar matematika asoslarini, dasturlash tilini, dasturlarni va ularni xavfsiz ishlashlarini ta`minlash bo`yicha bilimlarga ega bo`ladilar. Bundan tashqari talabalar asosiy til sifatida ingliz tilini hamda qo`shimcha til sifatida yapon, xitoy yoki koreys tillaridan birini o`rganadilar.</p>',
	},
]
